    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_time', models.CharField(blank=True, choices=[('17:30', '17:30'), ('17:45', '17:45'), ('18:00', '18:00'), ('18:15', '18:15')], max_length=5)),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('book_time', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='restaurant.time')),
